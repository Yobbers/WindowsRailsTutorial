...
First run command `$ cd workdirectory` and then inside your directory run `$ code .`. When you run Visual Studio Code for the first time within your WSL 2, Ubuntu will first install server components and launch the application afterwards.
